#Load data
data <- read.csv("C:\\Users\\workbench\\eirik_master\\Results\\linear_reg_1\\df")
...
#Modified Tukey test
turkey = as.matrix(sqrt(read.csv("C:\\Users\\workbench\\eirik_master\\Results\\linear_reg_1\\for_turkey_search")))
