#Load data
data <- read.csv("C:\\Users\\workbench\\eirik_master\\Results\\linear_reg_2_art\\df")
...
#Modified Tukey test
turkey = as.matrix(read.csv("C:\\Users\\workbench\\eirik_master\\Results\\linear_reg_1\\for_turkey_mpi_art"))
